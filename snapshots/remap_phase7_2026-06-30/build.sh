...
"${CXX}" "${FLAGS[@]}" test/perf_remap.cpp -o test/perf_remap
"${CXX}" "${FLAGS[@]}" test/test_remap_varshape.cpp -o test/test_remap_varshape
echo "[build.sh] built test/test_remap test/perf_remap test/test_remap_varshape"
